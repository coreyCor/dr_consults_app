...
class ConsultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consult" do
    assert_difference("Consult.count") do
      post consults_url, params: { consult: { asked_by: @consult.asked_by, assigned_to: @consult.assigned_to, body: @consult.body, status: @consult.status, title: @consult.title } }
    end
  ...
  test "should update consult" do
    patch consult_url(@consult), params: { consult: { asked_by: @consult.asked_by, assigned_to: @consult.assigned_to, body: @consult.body, status: @consult.status, title: @consult.title } }
